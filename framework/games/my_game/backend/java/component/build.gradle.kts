...
tasks.register<Exec>("generateWitBindings") {
    group = "codegen"
    description = "Regenerate wit/worlds/GameCore.java from game-core.wit (requires wit-bindgen-cli 0.40.x on PATH)."
    val wit = layout.projectDirectory.file("game-core.wit").asFile
